...
if __name__ == '__main__':
    ...
    train_set_path = "data/train_batch_5000.h5"
    val_set_path = "data/val_batch_5000.h5"

    save_name = f'edge_layers_{num_layers}_units_{units}_epochs_{num_epochs}_dim_{out_dim}_date_{dt.datetime.now().strftime("%Y-%m-%d")}'
    ...
    for epoch in tf.range(num_epochs):
        ...
        with summary_writer.as_default():
            ...
            if val_acc > max_val_acc:
                ...
                model.save_weights(f"checkpoint/{save_name}.weights.h5")
                max_epoch = epoch
